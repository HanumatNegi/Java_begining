...
public class Calculator_with_exception {
    ...
    // Validation method
    public static void exceptionHandling(int a, int b, String operation) throws InvalidInputException, MaxInputException, MaxMultiplierReachedException, CannotDivideByZeroException {
        if ((a == 8 && b == 9) || (a == 9 && b == 8)) {
        ...
        if (operation.equals("*") && (a > 7000 || b > 7000)) {
